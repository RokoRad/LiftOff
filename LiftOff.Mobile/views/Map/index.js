      ...
      return (
        <Screen current={this.props.location}>
          ...
          <DatePicker iconSource={require('../../images/map/date.png')} hideText={true}
            ...
            format="YYYY-MM-DD-hh-mm" minDate={new Date().toISOString().slice(0, 10)} maxDate={new Date(Date.now() + days * 24*60*60*1000).toISOString().slice(0, 10)}
            confirmBtnText="Confirm" cancelBtnText="Cancel" onDateChange={(date) => console.log(date)} />
