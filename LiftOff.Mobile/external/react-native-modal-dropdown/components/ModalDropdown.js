...
export default class ModalDropdown extends Component {
  ...
  _calcPosition() {
    ...
    let dropdownHeight =
      (this.props.dropdownStyle && StyleSheet.flatten(this.props.dropdownStyle).height) ||
    ...
    if (showInLeft) {
      ...
      let dropdownWidth =
        (this.props.dropdownStyle && StyleSheet.flatten(this.props.dropdownStyle).width) ||
    ...
    if (TOUCHABLE_ELEMENTS.find(name => name == row.type.displayName)) {
      ...
      switch (row.type.displayName) {
        ...
        case 'TouchableWithoutFeedback':
          {
            return (
              <TouchableWithoutFeedback {...props}>{row.props.children}</TouchableWithoutFeedback>
            );
          }
          break;
        case 'TouchableNativeFeedback':
          {
            return (
              <TouchableNativeFeedback {...props}>{row.props.children}</TouchableNativeFeedback>
            );
          }
          break;
        default:
